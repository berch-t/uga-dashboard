...
export function NotebooksExplorer({ entries }: { entries: NotebookEntry[] }) {
  ...
  return (
    <div className="grid gap-4 lg:grid-cols-[18rem_1fr]">
      <aside className="h-fit rounded-xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 lg:sticky lg:top-4">
        <NotebookSidebar entries={entries} activeId={activeId} onSelect={setActiveId} />
      </aside>
